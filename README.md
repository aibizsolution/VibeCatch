...
- Pro 기준: `490만 원/월`, `키워드 50`, `좌석 10`, `월 크레딧 100,000건`
- 모듈 구조: `VibeCatch(기본)` + 선택형 `AI Plus`, `Workflow`
- 과금 설명 키워드: `키워드/좌석/수집주기/크레딧` (+ 옵션으로 Export/연동 범위)
...
- `pricing.html` AI 크레딧 증량 단위 `10,000건` → `1,000건` 조정
- 3개 HTML 용어 통일: `Core` 표기 축소, `AC` 표기 → `AI 크레딧` 중심으로 정리
